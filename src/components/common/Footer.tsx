    ...
    <footer className="bg-secondary dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-around items-start space-y-8 md:space-y-0 md:space-x-16">
          <div>
            <img
              src="https://res.cloudinary.com/doetven6z/image/upload/v1725413887/logo_white_text_1_d2ahuc.svg"
              alt="Logo"
              className="h-12 w-auto mb-4"
            />
          </div>
          <div>
            <h6 className="font-poppins font-medium text-xl text-gray-100 mb-4">
              Services
            </h6>
            <ul className="space-y-2">
              {[
                ...
                <li key={service}>
                  <a
                    href="#"
                    className="font-poppins font-normal text-base text-gray-300 hover:text-white transition-colors"
                  >
                    {service}
                  </a>
                </li>
      ...
      <div className="bg-[#004D7B] dark:bg-gray-800 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-center items-center">
          <p className="text-[#F9F8F9] dark:text-gray-400 text-sm mb-4 sm:mb-0 font-poppins">
